                ...
                <>
                    ...
                    <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                        {issues.map((issue: any) => (
                            <div className="group bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer hover:-translate-y-1">
